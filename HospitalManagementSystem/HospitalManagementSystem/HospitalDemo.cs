...
namespace HospitalManagementSystem
{
    public class HospitalDemo
    {
        public void Run()
        {
            ...
            // Додавання лікарів
            var d1 = new Doctor(1, "Сумська Лідія ", "Терапевт");
            var d2 = new Doctor(2, "Небийголова Сергій ", "Хірург");
            var d3 = new Doctor(3, "Богоміл Тетяна ", "Педіатр");
            hospital.AddDoctor(d1);
            hospital.AddDoctor(d2);
            hospital.AddDoctor(d3);

            // Реєстрація пацієнтів
            var p1 = new Patient(1, "Пилипенко Віктор ", 34);
            var p2 = new Patient(2, "Назаренок Назар", 27);
            var p3 = new Patient(3, "Мульпа Олена", 56);
            var p4 = new Patient(4, "Бредд Питт", 42);
